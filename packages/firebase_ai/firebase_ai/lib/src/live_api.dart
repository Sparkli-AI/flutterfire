...
/// Represents a transcription response from the client in a live stream.
class Transcription implements LiveServerMessage {
  /// Creates a [OutputTranscription] instance.
  Transcription({this.text, this.finished});

  /// The text transcription.
  final String? text;

  /// Whether the transcription is finished.
  final bool? finished;

  // ignore: public_member_api_docs
  Map<String, dynamic> toJson() => {'text': text, 'finished': finished};
}
